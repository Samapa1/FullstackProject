In total 202 working hours used for the project. 
...
8.10.24           4                        Adding error-handling middleware and tokenextractor.
...
14.10.24          4                        Developing reservation functionality (removing reservation, database relations etc.)
15.10.24          2                        Developing reservation functionality (picking up reservations).
...
(16.10.24         1                        Setting up Frontend unit tests. *Removed, backend and e2e tests were sufficient.*)
...
17.10.24          1                        Fixing loan reducer and adding window confirms for reservations.
...
22.10.24          2.5                      Adding sessions and admin-users,connecting logout-functionality with frontend       
...
8.11.24           3                        Working on reservation functionality (removing old reservations with Bull).
...
17.12.24          1                        Developing update book functionality and errorhandling middleware.
...
9.1.25            4                        Setting the app on render and fixing login router (backend).
